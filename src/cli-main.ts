...
async function registerSandbox(sandboxId: string, jwt: string, name: string, clientConfig = null) {
  ...
  if(hasVariableForOrigin) {
    ...
    console.error(`Please edit the sandbox client configuration file /home/lgassawa/devpops/cli-sandbox/cache/sandbox-cli/sandbox-cli/sandboxes/DEVPOPS-789/config.json and replace the variable with a static hostname`);
  }
}
